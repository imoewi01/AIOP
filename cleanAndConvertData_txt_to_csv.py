...
def clean_file(inputFilePath, ColumnName, outputFilePath, badValues=["<<","Network","disconnection",">>"]):
    ...
    with open(inputFilePath,"r") as file:
        ...
        for line in line_list:
            ...
            output_line = output_time+","+split_line[2]
...
if __name__ == "__main__":
    ...
    clean_file("rawData/beamVariables/ac_x.txt","AC:X","csv_data/initial_converted/ac_x.csv")
    clean_file("rawData/beamVariables/ac_y.txt","AC:Y","csv_data/initial_converted/ac_y.csv")
    clean_file("rawData/beamVariables/ebeam_current.txt","EBEAM:CURRENT","csv_data/initial_converted/ebeam_current.csv")
    clean_file("rawData/beamVariables/ebeam_energy.txt","EBEAM:ENERGY","csv_data/initial_converted/ebeam_energy.csv")
    clean_file("rawData/beamVariables/ebeam_x.txt","EBEAM:X","csv_data/initial_converted/ebeam_x.csv")
    clean_file("rawData/beamVariables/ebeam_y.txt","EBEAM:Y","csv_data/initial_converted/ebeam_y.csv")
    clean_file("rawData/beamVariables/photonbeam_energy_desired.txt","PBEAM:SET","csv_data/initial_converted/photonbeam_energy_desired.csv")
    clean_file("rawData/beamVariables/photonbeam_energy_uncertainty.txt","PBEAM:WIDTH","csv_data/initial_converted/photonbeam_energy_uncertainty.csv")
    clean_file("rawData/beamVariables/photonbeam_energy.txt","PBEAM:ENERGY","csv_data/initial_converted/photonbeam_energy.csv")
    clean_file("rawData/beamVariables/radiator_id.txt","RADIATOR:ID","csv_data/initial_converted/radiator_id.csv")
    clean_file("rawData/beamVariables/radiator_name.txt","RADIATOR:NAME","csv_data/initial_converted/radiator_name.csv")
